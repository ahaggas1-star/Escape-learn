...
const FLOW = [
  ...
  { n: "7", t: "إدارة الأدوار", d: "/admin/users — مدير النظام يعيّن: ولي أمر / مدير محتوى / مدير نظام." },
  { n: "8", t: "لوحة النظام", d: "/admin/system — سجل الموافقات (consent) وسجل العمليات الحساسة (audit)." },
];
...
const GAMIFICATION = [
  ...
  "صناديق المكافآت تُفتح بعد إنجاز حقيقي فقط، باختيار تدويري شفّاف (بلا عشوائية/دفع).",
  "الترتيب بين الأسر مجهول الهوية افتراضيًا، ولا يعرض بيانات أطفال فردية.",
];
