  ...
  theme: {
    extend: {
      colors: {
        ...
        joy: { 50: "#fff7ed", 100: "#ffedd5", 200: "#fed7aa", 400: "#fb923c", 500: "#f97316", 600: "#ea580c" },
        sky: { 50: "#ecfeff", 100: "#cffafe", 200: "#a5f3fc", 400: "#22d3ee", 500: "#06b6d4", 600: "#0e7490" },
        bloom: { 50: "#fdf2f8", 100: "#fce7f3", 200: "#fbcfe8", 400: "#f472b6", 500: "#ec4899", 600: "#be1e6c" },
        grape: { 50: "#f5f3ff", 100: "#ede9fe", 200: "#ddd6fe", 400: "#a78bfa", 500: "#8b5cf6", 600: "#7c3aed" },
        leaf: { 50: "#f0fdf4", 100: "#dcfce7", 200: "#bbf7d0", 400: "#4ade80", 500: "#22c55e", 600: "#16a34a" },
