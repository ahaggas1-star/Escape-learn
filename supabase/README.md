...
- صندوق `qiyam-proofs` (خاص/غير عام) لإثباتات صور المهام — انظر `migrations/0008_storage_proofs.sql`.
- السياسات: المستخدم المصادق يرفع، ويقرأ/يحذف ما يملكه فقط؛ تُعرض الصور عبر روابط موقّعة.
